...
const week = [
    ...
    { value: '周三', class: '' },
    { value: '周四', class: '' },
    { value: '周五', class: 'moreHalfHour' },
    { value: '周六', class: 'moreHalfHour' },
]
...
Component({
    ...
    methods: {
        ...
        handleReset() {
            ...
            this.setData({ days })
            this.triggerEvent('selectedreset', {})
        },
        ...
        handleChooseToday() {
            let d = this.formatTime(today, 'yyyy-MM-dd')
            this.setData({ date: d })
            this.init()
            this.triggerEvent('handleinit', this.data.date)
        ...
        handleConfirm(e) {
            ...
            if (selected && selected.length > 0) {
                ...
                this.triggerEvent('onselectdate', { date: dateStr1, year: selected[0], month: selected[1], day: selected[2] })
            }
        },
    }
})